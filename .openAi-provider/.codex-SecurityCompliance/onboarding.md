...
3. **Wake-up & règles (SecurityCompliance)** : `.openAi-provider/.codex-SecurityCompliance/WAKEUP-LINK.md` — Retrouve intents, guardrails, références messaging.
...
- **Messagerie** : exécute `npm run arkamsg -- pull --agent arka-agent14-security-compliance-architect` dès l'ouverture de session, vérifie si des messages sont présents puis applique la procédure ARKORE20.

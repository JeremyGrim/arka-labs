...
3. **Wake-up & règles (ArchivistOrchestrator)** : `.openAi-provider/.codex-ArchivistOrchestrator/WAKEUP-LINK.md` — Retrouve intents, guardrails, références messaging.
...
- **Messagerie** : exécute `npm run arkamsg -- pull --agent arka-agent01-arka-archivist-orchestrator` dès l'ouverture de session, vérifie si des messages sont présents puis applique la procédure ARKORE20.

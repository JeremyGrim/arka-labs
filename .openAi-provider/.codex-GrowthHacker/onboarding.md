...
3. **Wake-up & règles (GrowthHacker)** : `.openAi-provider/.codex-GrowthHacker/WAKEUP-LINK.md` — Retrouve intents, guardrails, références messaging.
...
- **Messagerie** : exécute `npm run arkamsg -- pull --agent growth-hacker-specialist` dès l'ouverture de session, vérifie si des messages sont présents puis applique la procédure ARKORE20.

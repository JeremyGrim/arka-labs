...
3. **Wake-up & règles (MissionQualifier)** : `.openAi-provider/.codex-MissionQualifier/WAKEUP-LINK.md` — Retrouve intents, guardrails, références messaging.
...
- **Messagerie** : exécute `npm run arkamsg -- pull --agent mission-qualifier` dès l'ouverture de session, vérifie si des messages sont présents puis applique la procédure ARKORE20.

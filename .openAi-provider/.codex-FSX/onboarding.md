...
- **Messagerie** : exécute `npm run arkamsg -- pull --agent fsx-extreme-fullstack` dès l'ouverture de session, vérifie si des messages sont présents puis applique la procédure ARKORE20.

...
3. **Wake-up & règles (PipelineTracker)** : `.openAi-provider/.codex-PipelineTracker/WAKEUP-LINK.md` — Retrouve intents, guardrails, références messaging.
...
- **Messagerie** : exécute `npm run arkamsg -- pull --agent pipeline-tracker` dès l'ouverture de session, vérifie si des messages sont présents puis applique la procédure ARKORE20.

...
3. **Wake-up & règles (CompensationBenefits)** : `.openAi-provider/.codex-CompensationBenefits/WAKEUP-LINK.md` — Retrouve intents, guardrails, références messaging.
...
- **Messagerie** : exécute `npm run arkamsg -- pull --agent compensation-benefits-analyst` dès l'ouverture de session, vérifie si des messages sont présents puis applique la procédure ARKORE20.

...
3. **Wake-up & règles (AgentCreator)** : `.openAi-provider/.codex-AgentCreator/WAKEUP-LINK.md` — Retrouve intents, guardrails, références messaging.
...
- **Messagerie** : exécute `npm run arkamsg -- pull --agent arka-agent03-agent-creator-client` dès l'ouverture de session, vérifie si des messages sont présents puis applique la procédure ARKORE20.

...
3. **Wake-up & règles (HRTransformation)** : `.openAi-provider/.codex-HRTransformation/WAKEUP-LINK.md` — Retrouve intents, guardrails, références messaging.
...
- **Messagerie** : exécute `npm run arkamsg -- pull --agent hr-transformation-specialist` dès l'ouverture de session, vérifie si des messages sont présents puis applique la procédure ARKORE20.

...
3. **Wake-up & règles (LearningDevelopment)** : `.openAi-provider/.codex-LearningDevelopment/WAKEUP-LINK.md` — Retrouve intents, guardrails, références messaging.
...
- **Messagerie** : exécute `npm run arkamsg -- pull --agent learning-development-strategist` dès l'ouverture de session, vérifie si des messages sont présents puis applique la procédure ARKORE20.

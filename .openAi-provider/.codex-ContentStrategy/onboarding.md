...
3. **Wake-up & règles (ContentStrategy)** : `.openAi-provider/.codex-ContentStrategy/WAKEUP-LINK.md` — Retrouve intents, guardrails, références messaging.
...
- **Messagerie** : exécute `npm run arkamsg -- pull --agent content-strategy-manager` dès l'ouverture de session, vérifie si des messages sont présents puis applique la procédure ARKORE20.

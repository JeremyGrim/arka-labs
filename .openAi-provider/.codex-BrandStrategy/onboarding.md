...
3. **Wake-up & règles (BrandStrategy)** : `.openAi-provider/.codex-BrandStrategy/WAKEUP-LINK.md` — Retrouve intents, guardrails, références messaging.
...
- **Messagerie** : exécute `npm run arkamsg -- pull --agent brand-strategy-architect` dès l'ouverture de session, vérifie si des messages sont présents puis applique la procédure ARKORE20.

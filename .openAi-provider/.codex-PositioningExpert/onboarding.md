...
3. **Wake-up & règles (PositioningExpert)** : `.openAi-provider/.codex-PositioningExpert/WAKEUP-LINK.md` — Retrouve intents, guardrails, références messaging.
...
- **Messagerie** : exécute `npm run arkamsg -- pull --agent positioning-expert` dès l'ouverture de session, vérifie si des messages sont présents puis applique la procédure ARKORE20.

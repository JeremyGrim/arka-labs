...
3. **Wake-up & règles (TechArchitect)** : `.openAi-provider/.codex-TechArchitect/WAKEUP-LINK.md` — Retrouve intents, guardrails, références messaging.
...
- **Messagerie** : exécute `npm run arkamsg -- pull --agent technical-architect` dès l'ouverture de session, vérifie si des messages sont présents puis applique la procédure ARKORE20.

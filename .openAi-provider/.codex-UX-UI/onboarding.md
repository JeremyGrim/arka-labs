...
3. **Wake-up & règles (UX-UI)** : `.openAi-provider/.codex-UX-UI/WAKEUP-LINK.md` — Retrouve intents, guardrails, références messaging.
...
- **Messagerie** : exécute `npm run arkamsg -- pull --agent ux-ui-design-guardian` dès l'ouverture de session, vérifie si des messages sont présents puis applique la procédure ARKORE20.

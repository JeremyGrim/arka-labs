...
3. **Wake-up & règles (OutreachStrategist)** : `.openAi-provider/.codex-OutreachStrategist/WAKEUP-LINK.md` — Retrouve intents, guardrails, références messaging.
...
- **Messagerie** : exécute `npm run arkamsg -- pull --agent outreach-strategist` dès l'ouverture de session, vérifie si des messages sont présents puis applique la procédure ARKORE20.

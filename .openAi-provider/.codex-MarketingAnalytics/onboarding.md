...
3. **Wake-up & règles (MarketingAnalytics)** : `.openAi-provider/.codex-MarketingAnalytics/WAKEUP-LINK.md` — Retrouve intents, guardrails, références messaging.
...
- **Messagerie** : exécute `npm run arkamsg -- pull --agent marketing-analytics-expert` dès l'ouverture de session, vérifie si des messages sont présents puis applique la procédure ARKORE20.
